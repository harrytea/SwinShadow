...
function [acc_final, final_BER, pErr, nErr, stats] = ComputeBERonSet(GTFolder, PredFolder)
	...
	for i=1:numel(dImg)
        ...
        gtImg = gpuArray(gtImg);  % gpuarray
        predImg = gpuArray(predImg);  % gpuarray
