...
class CustomDataset(Dataset):
    def __init__(self, image_size=512):
        ...
        # ISTD
        self.imgs_path = '/data/wangyh/data4/Datasets/shadow/ISTD_Dataset/train/train_A'
        self.labs_path = '/data/wangyh/data4/Datasets/shadow/ISTD_Dataset/train/train_B'
...
class TestDataset(Dataset):
    def __init__(self, image_size=512):
        ...
        self.image_size = image_size
        # ISTD
        self.imgs_path = '/data/wangyh/data4/Datasets/shadow/ISTD_Dataset/test/test_A'
        self.labs_path = '/data/wangyh/data4/Datasets/shadow/ISTD_Dataset/test/test_B'
        self.imgs = sorted(os.listdir(self.imgs_path))
        self.labs = sorted(os.listdir(self.labs_path))
